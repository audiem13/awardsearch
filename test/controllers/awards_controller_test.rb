...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { arrival: @award.arrival, departure: @award.departure, level: @award.level, miles: @award.miles, title: @award.title }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { arrival: @award.arrival, departure: @award.departure, level: @award.level, miles: @award.miles, title: @award.title }
    assert_redirected_to award_path(assigns(:award))
  end
